...
#define OW_TIMER_INSTANCE 1

// 1-wire manager queue capacity
#define OW_MANAGER_FIFO_SIZE 16

// if not defined, driver functionality for ROM searching excluded
#define OW_ROM_SEARCH_SUPPORT

// if not defined, driver functionality for parasite power support excluded
#define OW_PARASITE_POWER_SUPPORT 

// if defined, separated pin for power forcing used
// else out pin reconfigures temporary
...
//           { { IN0,  OUT0 }, { IN1,  OUT1 } }
#define OW_PINS_ARRAY  { { 2,  3, 14}, {23, 24, 14}, { 4,  5, 14} }
